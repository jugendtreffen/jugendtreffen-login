...
const senderEmail = process.env.BREVO_SENDER_EMAIL ?? 'anmeldung@jugendtreffen.at'
const senderName = process.env.BREVO_SENDER_NAME ?? 'Anmeldung@Jugendtreffen in Kremsmünster'
