...
export function DataTableSliderFilter<TData>({
  ...
  return (
    <Popover>
      ...
      <PopoverContent align="start" className="dark:flex dark:w-auto dark:flex-col dark:gap-4">
        <div className="dark:flex dark:flex-col dark:gap-3">
          <p className="dark:font-medium dark:leading-none dark:peer-disabled:cursor-not-allowed dark:peer-disabled:opacity-70">
            {title}
          </p>
          <div className="dark:flex dark:items-center dark:gap-4">
            <Label htmlFor={`${id}-from`} className="dark:sr-only">
              From
            </Label>
            <div className="dark:relative">
              <Input
                ...
                className={cn("dark:h-8 dark:w-24", unit && "dark:pr-8")}
              />
              {unit && (
            ...
            <Label htmlFor={`${id}-to`} className="dark:sr-only">
              to
            </Label>
            <div className="dark:relative">
              <Input
          ...
          <Label htmlFor={`${id}-slider`} className="dark:sr-only">
            {title} slider
          </Label>
          <Slider
            id={`${id}-slider`}
