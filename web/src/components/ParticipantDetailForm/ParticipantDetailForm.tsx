...
import CheckinDialog from "@/components/ParticipantDetailForm/CheckinDialog";
...
const ParticipantDetailForm = ({participant, loading}: Props) => {
  ...
  return (
    ...
    <Form formMethods={form}>
      <div className="grid grid-cols-4 gap-2">
        ...
        <div className="flex flex-row justify-between w-full col-span-4">
          ...
          {participant.checkinConfirmed ? (
            <Button disabled={saving} onClick={() => setSubState("Overview")}>
      ...
      <CheckinDialog onCheckin={onCheckin} saving={saving} acceptPhotos={participant.acceptPhotos} form={form} />
