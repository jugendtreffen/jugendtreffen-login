...
function MaskInput(props: MaskInputProps) {
  ...
  return (
    <InputPrimitive
      ...
      {...inputProps}
      className={cn(
        "dark:flex dark:h-9 dark:w-full dark:min-w-0 dark:rounded-md dark:border dark:border-input dark:bg-transparent dark:px-3 dark:py-1 dark:text-base dark:shadow-xs dark:outline-none dark:transition-[color,box-shadow] dark:selection:bg-primary dark:selection:text-primary-foreground dark:file:inline-flex dark:file:h-7 dark:file:border-0 dark:file:bg-transparent dark:file:font-medium dark:file:text-foreground dark:file:text-sm dark:placeholder:text-muted-foreground dark:disabled:pointer-events-none dark:disabled:cursor-not-allowed dark:disabled:opacity-50 dark:md:text-sm dark:bg-input/30",
        "dark:focus-visible:border-ring dark:focus-visible:ring-[3px] dark:focus-visible:ring-ring/50",
        "dark:aria-invalid:border-destructive dark:aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40",
        className,
      )}
