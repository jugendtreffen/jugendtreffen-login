    ...
    <>
      ...
      <section id="Socials" className="flex flex-col p-6 md:px-12 mx-auto lg:py-0 h-full w-full my-12 gap-2">
        <div className="flex flex-row flex-wrap gap-4 w-full">
          ...
          <a href="https://www.jugendtreffen.at" target="_blank" rel="noreferrer">
            <Card description="Mehr Infos auf unserer">
              <div className="flex flex-row gap-2 mb-2 h-8">
                <img className="h-8 rounded-full" src="/website-white.png" alt="logo" />
                <h2>Website</h2>
              </div>
            </Card>
          </a>
          <a href="https://www.instagram.com/jugendtreffen/" target="_blank" rel="noreferrer">
            <Card description="Folge uns auf Instagramm">
              <div className="flex flex-row gap-2 mb-2 h-8">
                <img className="h-8 rounded-full" src="/instagramm-white.png" alt="logo" />
                <h2>jugendtreffen</h2>
              </div>
            </Card>
          </a>
